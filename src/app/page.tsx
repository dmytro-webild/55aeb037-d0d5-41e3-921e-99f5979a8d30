...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Alex Rivers",
          handle: "@arivers",
          testimonial: "The best agency partnership we've ever had. ROI tripled in six months.",
          rating: 5,
        ...
        },
        {
          name: "Maria Chen",
          handle: "@mchen",
          testimonial: "Professional, data-driven, and highly creative. Truly top-tier results.",
          rating: 5,
        ...
        },
        {
          name: "Jordan Smith",
          handle: "@jsmith",
          testimonial: "Vantage shifted our entire brand narrative. Absolutely premium service.",
          rating: 5,
        ...
        },
        {
          name: "Sam Taylor",
          handle: "@staylor",
          testimonial: "Vantage delivers consistent results with unmatched creativity.",
          rating: 5,
        ...
        },
        {
          name: "Elena Ross",
          handle: "@eross",
          testimonial: "Scaling our brand was effortless thanks to their strategic approach.",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/young-manager-standing-up-relieve-back-pain_482257-67482.jpg",
          alt: "Team member 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/funny-guy-trying-sunglasses-eyewear-store-dancing-having-fun-standing-blue-background_1258-153238.jpg",
          alt: "Team member 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/universal-cables-gadgets-neon-charging-data_169016-71502.jpg",
          alt: "Team member 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/closeup-hand-pressing-screen_53876-101866.jpg",
          alt: "Team member 4",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      description="Vantage Social isn't just about 'posting'. We integrate deep psychological insights, high-end production, and rigorous data analysis to build sustainable digital influence."
    />
  </div>
      ...
      features={[
        {
          ...
          description: "Defining your unique brand voice.",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-geometric-shapes-indoors-background_23-2150697326.jpg",
          buttonIcon: "Zap",
        },
        {
          title: "Production Studio",
          description: "High-fidelity content creation.",
          imageSrc: "http://img.b2bpic.net/free-photo/overhead-view-laptop-with-camera-accessories-white-desk_23-2147924109.jpg",
          buttonIcon: "Camera",
        },
        {
          title: "Performance Analytics",
          description: "Real-time data and optimization.",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/blue-light-portrait-background_23-2149594599.jpg",
          buttonIcon: "Share2",
        },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          ...
          value: "2.4M",
          title: "Reach",
          description: "Monthly targeted impression count.",
        ...
        },
        {
          ...
          value: "120+",
          title: "Campaigns",
          description: "Successful full-cycle launches.",
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          role: "CMO",
          testimonial: "Unparalleled expertise in strategy.",
        ...
        },
        {
          ...
          name: "Mike D.",
          role: "CEO",
          testimonial: "Vantage understands scale.",
        ...
        },
        {
          ...
          name: "John K.",
          role: "Founder",
          testimonial: "Serious results, zero fluff.",
        ...
        },
        {
          ...
          name: "Lisa R.",
          role: "Manager",
          testimonial: "Transformation was immediate.",
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Get In Touch",
          href: "mailto:hello@vantagesocial.com",
        },
      ]}
    />
  </div>
